...
public class CPPDockerCodeSandbox extends DockerCodeSandboxTemplate {
    ...
    public static void main(String[] args) {
        CPPDockerCodeSandbox javaNativeCodeSandbox = new CPPDockerCodeSandbox();
        ExecuteCodeRequest executeCodeRequest = new ExecuteCodeRequest();
        executeCodeRequest.setInputList(Arrays.asList("1 2", "1 3"));
        String code = ResourceUtil.readStr("testCode/simpleComputeArgs/Main(c++).cpp", StandardCharsets.UTF_8);
